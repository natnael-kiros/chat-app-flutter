 ...
 **Server**: A Dart server that manages user requests, authentication, and real-time messaging. (See [Chat App Server Repository https://github.com/natnel-kiros/chat-app-server.git](https://github.com/natnel-kiros/chat-app-server.git) for more details.)
